...
Julia and Emil have written an amazing text processing book: [_Supervised Machine Learning for Text Analysis in R_](https://smltar.com/) and we can use  `r pkg(textrecipes)` for processing the raw text data. 
...
There is a lot more that can be done with text and I highly recommend taking a look at [SMTAR](https://smltar.com/).
